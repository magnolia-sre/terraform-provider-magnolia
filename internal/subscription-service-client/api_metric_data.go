...
func (r ApiGetSubscriptionMetricsRequest) Execute() (*MetricResponse, *http.Response, error) {
	return r.ApiService.GetSubscriptionMetricsExecute(r)
}
...
func (a *MetricDataApiService) GetSubscriptionMetricsExecute(r ApiGetSubscriptionMetricsRequest) (*MetricResponse, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MetricDataApiService.GetSubscriptionMetrics")
	if err != nil {
